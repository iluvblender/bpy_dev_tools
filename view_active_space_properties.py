...
class ContextSpaceData(bpy.types.Operator):
    ...
    def draw(self, context):
        ...
        col1 = split.column()
        col2 = split.column()
        col1.label(text="rna_type")
        col2.label(text=context.space_data.rna_type.description)
        ...
        if self.prop_type != 'ALL':
            ...
            if missing_prop_tags:
                ...
                column.label(text=missing_prop_tags_string)
        ...
        for key in prop_map:
            ...
            if not prop_map[key]:
                column.label(text="No definitions available of this type")
                continue
            for prop in prop_map[key]:
                ...
                col2.label(text=prop.description)
                col1.label(text='')
